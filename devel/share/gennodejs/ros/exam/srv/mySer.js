...
class mySerRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type mySerRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type mySerRequest
    let len;
    let data = new mySerRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new mySerRequest(null);
...
class mySerResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type mySerResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type mySerResponse
    let len;
    let data = new mySerResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new mySerResponse(null);
...
module.exports = {
  Request: mySerRequest,
  Response: mySerResponse,
  md5sum() { return '0d48ea28d372a544a46a655505887e00'; },
  datatype() { return 'exam/mySer'; }
};
